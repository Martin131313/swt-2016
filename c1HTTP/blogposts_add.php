...
if(0 == $err){
	...
	if($e){
		...
		$db = $db = new PDO('mysql:dbname=homework_db;host=127.0.0.1', 'root', 'root');
		$db->query('set names utf8');

		$sql = 'insert into blogposts (title,content,publish_date,id_category, image) values
			(:title, :content, :publish_date, :id_category, :image)';
